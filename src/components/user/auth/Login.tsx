  ...
  return (
    <div className="bg-gray-100 min-h-screen  flex items-center justify-center">
      <div className="flex flex-col md:flex-row items-center md:space-x-24 p-6">
        <Cpage/>
        <form onSubmit={handleSubmit} className="mt-8 md:mt-0 md:w-1/2 bg-white p-8 rounded-lg shadow-md max-w-md">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <button className="w-full py-2 px-4 bg-gray-800 text-white rounded hover:bg-black transition rounded-md" disabled={loading}>
